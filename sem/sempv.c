...
int mp_sem_create(int key);
int mp_sem_delete(int semid);
int mp_sem_acquire(int semid);
int mp_sem_release(int semid);
...
int main(int argc, char *argv[])
{
	...
	printf("key: %d, sem_id: %d\n", key, sem_id);
	mp_sem_acquire(sem_id);
	return 0;
#else
	int i;
	int pause_time;
